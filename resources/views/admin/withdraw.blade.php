        ...
        <div class="flex items-center space-x-4 py-5 lg:py-6">
          ...
          <div>
            <div class="flex items-center justify-between">
              ...
              <div class="flex">
                <a href="{{route('admin.add_withdrawals')}}"
                     ...
                     <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div class="avatar flex h-10 w-10">
                            <img class="mask is-squircle" alt="avatar" src="{{ $withdrawal->image }}">
                          </div>
                        </td>
                        <td class="whitespace-nowrap px-3 py-3 font-medium text-slate-700 dark:text-navy-100 lg:px-5">{{$withdrawal->title}}</td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$withdrawal->points}}</td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{$withdrawal->price}}</td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          ...
                          <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="if(isShowPopper) isShowPopper = false" class="inline-flex">
                            ...
                            <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(366px, 260px);" data-popper-placement="bottom-end" data-popper-reference-hidden="" data-popper-escaped="">
                              <div class="popper-box rounded-md border border-slate-150 bg-layot-dark_csm py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                                <ul>
                                  <li>
                                    <a href="{{url('/admin/edit-withdrawals', $withdrawal->id)}}" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Edit</a>
                                  </li>
                                ...
                                <ul>
                                  <li>
                                    <a href="delete-withdrawals/{{$withdrawal->id}}" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Delete</a>
                                  </li>
                                </ul>
                              </div>
                            </div>
